...
class AppControllerPDO {
    private $user;
    private $lang_login;
    private $lang_form;
    private $lang_feedback;

    public function __construct($lang_login, $lang_form, $lang_feedback) {
        $this->user = new UserPDO();
...
$app = new AppControllerPDO($lang_login, $lang_form, $lang_feedback);
$app->handleRequest(); 