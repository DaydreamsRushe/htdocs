...
<body class="container-fluid">
    ...
    <div class="container mx-5 my-3">
        <form method="post" class="mb-3" action="../controller/app.php">
            {{::label_usuario::}}: <br>
            <input type="text" class="{{::class_error::}}" name="usuario" value="{{::usuario::}}" /><br><br>
            {{::label_email::}}: <br>
            <input type="text" class="{{::class_error::}}" name="email" value="{{::email::}}" /><br><br>
            {{::label_pwd::}}: <br>
            ...
            <div class="text-center mt-3">
                <a href="../controller/app.php">{{::register_link::}}</a>
            </div>
            {{::mensaje_error::}}
        </form>
